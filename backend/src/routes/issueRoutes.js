...
const { protect, optionalAuth, authorize, requireIdentityVerification } = require('../middleware/auth');
...
router.post('/', protect, requireIdentityVerification, issueSubmissionLimiter, upload.array('images', 3), createIssue);
